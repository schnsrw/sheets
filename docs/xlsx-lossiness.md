...
| Probe | Reference | Actual | Status |
| --- | --- | --- | --- |
| C2 → github.com/schnsrw/sheets | `"https://github.com/schnsrw/sheets"` | `∅` | ❌ |

## Comments

| Probe | Reference | Actual | Status |
| --- | --- | --- | --- |
| B2 comment text | `"This is a comment on Q1 revenue."` | `∅` | ❌ |
...
| header (left text) | `"&LCasual Sheets Audit"` | `∅` | ❌ |

## Tables

| Probe | Reference | Actual | Status |
| --- | --- | --- | --- |
| PeopleTable defined | `true` | `false` | ❌ |
